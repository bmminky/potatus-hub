...
**potato + status** — a small, local-first system monitor for Apple Silicon Macs.
...
Download the latest Apple Silicon build from [GitHub Releases](../../releases/latest).
...
**potato + status**에서 이름을 가져온 Apple Silicon Mac용 로컬 시스템 모니터입니다.
...
지원 환경은 **macOS 13 Ventura 이상 / Apple Silicon Mac**입니다.
